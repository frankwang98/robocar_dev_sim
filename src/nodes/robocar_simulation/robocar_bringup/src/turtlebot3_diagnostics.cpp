...
#include <msg_common/SensorState.h>
#include <msg_common/VersionInfo.h>
#include <string>
...
void sensorStateMsgCallback(const msg_common::SensorState::ConstPtr &msg)
{
    if (msg->battery > 11.0)
    ...
    if (msg->button == msg_common::SensorState::BUTTON0)
        setButtonDiagnosis(diagnostic_msgs::DiagnosticStatus::OK, "BUTTON 0 IS PUSHED");
    else if (msg->button == msg_common::SensorState::BUTTON1)
...
void firmwareVersionMsgCallback(const msg_common::VersionInfo::ConstPtr &msg)
{
    ...
    msg_common::VersionInfo version;
...
int main(int argc, char **argv)
{
    ...
    tb3_version_info_pub = nh.advertise<msg_common::VersionInfo>("version_info", 10);
