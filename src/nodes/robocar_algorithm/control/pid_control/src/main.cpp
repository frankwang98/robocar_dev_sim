...
double dt = 0.1, maxT = M_PI, minT = -M_PI, Kp = 0.3, Ki = 0.05, Kd = 0.1; // wangzf modify
...
int main(int argc, char **argv) {
    ...
    std::cout << "Starting pid_control node" << std::endl;
...
//If lines are long and it has sharp edges
        ...
        ROS_INFO("Odom_yaw %f, Angle Error: %f, omega: %f | Speed %f, Speed Error: %f, speedSet: %f", 
                 Odom_yaw, angleError, omega, Odom_v, speedError, speed);
